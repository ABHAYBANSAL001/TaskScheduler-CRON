...
//   Loader2,
//   Clock,
//   Send, // Changed to Send icon for "Post Now"
//   Plus,
//   Lock,
//   AlertTriangle,
//   Zap,
...
//       if (input) {
//         // Use type assertion for modern API support
...
//     setScheduledDate(date);
//     setValidationError(null);
//     // Note: We leave menu open so user sees what they picked
//   };
...
//     // --- CRITICAL: INSTANT vs SCHEDULED LOGIC ---
//     let finalDate: Date;

//     if (scheduledDate) {
//       // Scenario A: User picked a time -> Schedule it
//       finalDate = scheduledDate;
//     } else {
//       // Scenario B: User clicked "Post Now" -> Instant
//       // passing new Date() means "Execute immediately"
//       finalDate = new Date();
//     }
...
//               className="w-full bg-transparent border-none text-lg text-white placeholder:text-zinc-600 p-0 resize-none min-h-[80px] leading-relaxed focus:ring-0 scrollbar-hide outline-0"
//             />
...
//                       className="ml-2 text-[10px] text-zinc-500 hover:text-blue-400 flex items-center gap-1 group"
//                     >
...
//                     />
//                     {showEmojiPicker && (
//                       <div className="absolute bottom-full left-0 mb-2 bg-zinc-950 border border-zinc-800 rounded-xl shadow-2xl p-3 z-50 w-64 ring-1 ring-white/10 animate-in fade-in zoom-in-95">
...
//                   {scheduledDate ? (
//                     // ACTIVE STATE (Date Chosen)
//                     <div className="flex items-center gap-2 bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 px-3 py-2 rounded-xl text-xs font-bold animate-in zoom-in">
...
//                   {/* SCHEDULE POPOVER */}
//                   {isScheduleOpen && (
//                     <div className="absolute bottom-full right-0 mb-2 w-72 max-w-[90vw] bg-zinc-950 border border-zinc-800 rounded-xl shadow-2xl z-50 overflow-hidden ring-1 ring-white/10 animate-in fade-in zoom-in-95 origin-bottom-right">
...
//                   disabled={isPending}
//                   className={`
//                     relative flex items-center gap-2 px-6 py-2.5 rounded-xl font-bold text-sm transition-all duration-300 shadow-lg
//                     ${isPending ? "bg-zinc-800 text-zinc-500" : "bg-white text-black hover:bg-zinc-200 hover:scale-[1.02] shadow-white/10"}
//                   `}
//                 >
//                   {isPending ? (
...
//         </button>
//         <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 w-max px-3 py-1.5 bg-zinc-900 border border-white/10 text-zinc-300 text-[10px] rounded shadow-xl opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none z-50">
//           Not connected
//         </div>
//       </div>
//     );
